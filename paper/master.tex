...
\author{Kevin D. Duncan, Georgeanne M. Artz, Peter F. Orazem}
\date{}
\maketitle
...
\input{../analysis/output/_--_summary_table.tex}

\begin{figure}[h]\label{pairs}
    \centering
    \caption{Tax Rates Scatterplot}
    \includegraphics[scale = 0.5]{../analysis/output/_--_pairs.png}
\end{figure}

\begin{figure}[h]\label{pairsL1}
\centering
\caption{Differenced Tax Rates Scatterplot}
\includegraphics[scale=0.5]{../analysis/output/_--_pairsL1.png}
\end{figure}

\begin{landscape}
\small
\input{../analysis/output/_--_rd_results.tex}
\end{landscape}

\input{../analysis/output/_--_rd_Ftests.tex}

\begin{landscape}
\small
\input{../analysis/output/_--_eb_results.tex}
\end{landscape}

%\input{../analysis/output/_--_eb_Ftests.tex}

\input{../analysis/output/_--_no_equality_rd_results.tex}

\input{../analysis/output/_--_Ftests.tex}

%\input{../analysis/output/_--_region_rd_results.tex}
\input{../analysis/output/_--_metro_rd_results.tex}
\input{../analysis/output/_--_metrord_Ftests.tex}
%\input{../analysis/output/_--_urban_rd_results.tex}



\input{../analysis/output/_--_year_rd_results1.tex}
\input{../analysis/output/_--_year_rd_results2.tex}

\begin{landscape}
\input{../analysis/output/naics_subcodes.tex}
\end{landscape}

\input{../analysis/output/_--_agreements_rd_results.tex}
%\input{../analysis/output/_--_emp_rd_results.tex}

\input{../analysis/output/_--_agreerd_Ftests.tex}

\begin{figure}[h]\label{weightedtax}
    \centering
    \caption{2008 Weighted Tax Differential}
    \includegraphics[scale = 0.5]{../analysis/output/_--_weightedtax.png}
\end{figure}

\input{../analysis/output/entryCorrelations.tex}

\input{../analysis/output/_--_meantable.tex}
\input{../analysis/output/_--_taxtable.tex}
