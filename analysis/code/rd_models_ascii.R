...
for (m in 1:length(naics)){
  ...
  stargazer(sum, type = "text", out = paste("~/papers/firm_entry/analysis/output/", naics[m], "summary_table.txt", sep = "_"),
  ...
  stargazer(ftest, type = "text", title = paste("F-Tests for Symmetry of Coefficients for", naics_names[m], "Firm Start Ups", sep = " ")
            , label = paste(naics[m],"Ftests", sep = ""), colnames = TRUE, digits = 3,
            out = paste("~/papers/firm_entry/analysis/output/",naics[m],"Ftests.txt", sep = "_"))
  
  write(stargazer(pols1_amen_r_coef, pols1_r_coef, label = paste(naics[m],"noequality", sep =""), type = "text",
        ...
        paste("~/papers/firm_entry/analysis/output/", naics[m], "no_equality_rd_results.txt", sep = "_"))
  ...
  # write tables
  write(stargazer(pols_amen_c_r_coef, pols_namen_c_r_coef, pols_amen_nc_r_coef, pols_namen_nc_r_coef, pols_amen_fe, pols_fe,
                  type = "text", label = paste(naics[m], "rd", sep = ""), dep.var.labels = c("births ratio"), model.names = FALSE,
        ...
        paste("~/papers/firm_entry/analysis/output/", naics[m], "rd_results.txt", sep = "_"))
  ...
  write(stargazer(pols_1999,pols_2000,pols_2001,pols_2002,pols_2003,pols_2004,pols_2005,pols_2006,pols_2007,pols_2008,pols_2009,
                  type = "text", dep.var.labels = c("births ratio"), label = paste(naics[m],"year",sep=""), font.size = "small",
                  ...
                  no.space = TRUE, title = paste("Psuedo-RD for Stability over Time for ", naics_names[m], "Firm Births", sep = " ")), paste("~/papers/firm_entry/analysis/output/", naics[m], "year_rd_results.txt", sep = "_"))
  ...
  write(stargazer(dl_amen_c_r_coef, dl_amen_nc_r_coef, dl_namen_c_r_coef,dl_namen_nc_r_coef, dl_amen_fe, dl_fe,
                  type = "text", dep.var.labels = c("births ratio"), model.names = FALSE,
                  covariate.labels = c("Property Tax Difference", "Income Tax Difference", "Capital Gains Tax Difference",
                                       "Sales Tax Difference", "Corp Tax Difference", "Workers Comp Tax Difference",
                                       "Unemp. Tax Difference", "Educ Spending Per Cap Diff", "Highway Spending Per Cap Diff",
                                       "Welfare Spending Per Cap Diff"),
        ...
        paste("~/papers/firm_entry/analysis/output/", naics[m], "dl_rd_results.txt", sep = "_"))
  ...
  # write tables
  write(stargazer(pols_amen_c_r_coef, pols_namen_c_r_coef, pols_amen_nc_r_coef, pols_namen_nc_r_coef, pols_amen_fe, pols_fe, 
                  type = "text", label = paste(naics[m], "eb", sep = ""), dep.var.labels = c("births ratio"), model.names = FALSE,
                  covariate.labels = c("Property Tax Difference", "Income Tax Difference", "Capital Gains Tax Difference",
                                       "Sales Tax Difference", "Corp Tax Difference", "Workers Comp Tax Difference",
                                       "Unemp. Tax Difference", "Educ Spending Per Cap Diff", "Highway Spending Per Cap Diff",
                                       "Welfare Spending Per Cap Diff"),
        ...
        paste("~/papers/firm_entry/analysis/output/", naics[m], "eb_results.txt", sep = "_"))
  ...
  write(stargazer(pols_1999,pols_2000,pols_2001,pols_2002,pols_2003,pols_2004,pols_2005,pols_2006,pols_2007,pols_2008,pols_2009, 
                  type = "text", dep.var.labels = c("births ratio"), label = paste(naics[m], "ebyear"), font.size = "small",
        ...
        paste("~/papers/firm_entry/analysis/output/", naics[m], "year_eb_results.txt", sep = "_"))
  ...
  write(stargazer(dl_amen_c_r_coef, dl_amen_nc_r_coef, dl_namen_c_r_coef, dl_namen_nc_r_coef,   dl_amen_fe, dl_fe, 
                  type = "text", dep.var.labels = c("births ratio"),
                  covariate.labels = c("Property Tax Difference", "Income Tax Difference", "Capital Gains Tax Difference",
                                       "Sales Tax Difference", "Corp Tax Difference", "Workers Comp Tax Difference",
                                       "Unemp. Tax Difference", "Educ Spending Per Cap Diff", "Highway Spending Per Cap Diff",
                                       "Welfare Spending Per Cap Diff"),
        ...
        paste("~/papers/firm_entry/analysis/output/", naics[m], "dl_eb_results.txt", sep = "_"))
  rm(master)
}

stargazer(pols_na_c_11, pols_na_nc_11,pols_na_c_31_33, pols_na_nc_31_33,pols_na_c_44_45, pols_na_nc_44_45,pols_na_c_52,pols_na_nc_52,
          type = "text", dep.var.labels = c("births ratio"), font.size = "small", label = "naics",
          covariate.labels = c("Property Tax Difference", "Income Tax Difference", "Capital Gains Tax Difference",
                               "Sales Tax Difference", "Corp Tax Difference", "Workers Comp Tax Difference",
                               "Unemp. Tax Difference", "Educ Spending Per Cap Diff", "Highway Spending Per Cap Diff",
                               "Welfare Spending Per Cap Diff"),
          ...
          out = "~/papers/firm_entry/analysis/output/naics_subcodes.txt")
