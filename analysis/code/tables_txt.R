...
stargazer(datmerge[1:50,], type = "text", summary = FALSE, rownames = FALSE, font.size = "tiny",
          title = "Top 50 Weighted Tax Differentials for Total Firm Births", 
          out = "~/papers/firm_entry/analysis/output/_--_wtr.txt")
...
stargazer(mean[1:50,], type = "text", summary = FALSE, rownames = FALSE, font.size = "tiny",
          title = "Result Comparison for Total Firm Births", 
          out = "~/papers/firm_entry/analysis/output/_--_meantable.txt")
